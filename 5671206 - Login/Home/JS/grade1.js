document.addEventListener("DOMContentLoaded", function() {
    ...
    const allGradeData = {
        "2568": {
            ...
            subjects: [
                { code: "1234567", name: "วิชาตัวเบา", year: "1", teacher: "อ.ถังซาน", grade: "รอผล" },
                { code: "1234567", name: "วิชาตัวเบา", year: "2", teacher: "อ.ถังซาน", grade: "รอผล" },
                { code: "1234567", name: "วิชาตัวเบา", year: "3", teacher: "อ.ถังซาน", grade: "รอผล" },
                { code: "1234567", name: "วิชาตัวเบา", year: "4", teacher: "อ.ถังซาน", grade: "รอผล" }
        ...
        "2567": {
            ...
            subjects: [
                { code: "test", name: "test", year: "1", teacher: "test", grade: "เกรด", link: "#" },
                { code: "test", name: "test", year: "1", teacher: "test", grade: "เกรด", link: "#" },
                { code: "test", name: "test", year: "2", teacher: "test", grade: "เกรด", link: "#" },
                { code: "test", name: "test", year: "1", teacher: "test", grade: "เกรด", link: "#" },
                { code: "test", name: "test", year: "3", teacher: "test", grade: "เกรด", link: "#" },
                { code: "test", name: "test", year: "1", teacher: "test", grade: "เกรด", link: "#" },
                { code: "test", name: "test", year: "1", teacher: "test", grade: "เกรด", link: "#" },
                { code: "test", name: "test", year: "4", teacher: "test", grade: "เกรด", link: "#" },
                { code: "test", name: "test", year: "1", teacher: "test", grade: "เกรด", link: "#" },
                { code: "test", name: "test", year: "1", teacher: "test", grade: "เกรด", link: "#" },
                { code: "test", name: "test", year: "1", teacher: "test", grade: "เกรด", link: "#" },
                { code: "test", name: "test", year: "1", teacher: "test", grade: "เกรด", link: "#" },
        ...
        "2566": {
            ...
            subjects: [
                { code: "999", name: "how to fly", year: "1", teacher: "Mr.IDK", grade: "เกรด", link: "#" },
                { code: "999", name: "god", year: "1", teacher: "God", grade: "เกรด", link: "#" }
            ]
        },
        "test1": {
            approvalDate: "อนุมัติผลเมื่อวันที่ 18 ตุลาคม 2566",
